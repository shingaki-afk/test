...
//namespace KanriKeisuSyukei.Properties
//{
//    internal class Com
//    {
//    }
...
namespace KanriKeisuSyukei
{
    class Com
    {
        ...
        public static string isOneByteChar(string str)
        {
            ...
            {
                //全角変換
                return Microsoft.VisualBasic.Strings.StrConv(str, Microsoft.VisualBasic.VbStrConv.Wide, 0);
            }
            else
            {
                //半角変換
                return Microsoft.VisualBasic.Strings.StrConv(str, Microsoft.VisualBasic.VbStrConv.Narrow, 0);
            }
        }
