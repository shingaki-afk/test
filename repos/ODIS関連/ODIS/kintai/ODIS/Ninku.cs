...
namespace ODIS.ODIS
{
    public partial class Ninku : Form
    {
        public Ninku()
        {
            InitializeComponent();
            ...
            try
            {
                using (Cn = new SqlConnection(Common.constr))
                {
                    ...
                    using (Cmd = Cn.CreateCommand())
                    {
                        ...
                        //現場経費
                        Cmd.Parameters.Add(new SqlParameter("現場旅費交通費", SqlDbType.VarChar));
                        Cmd.Parameters["現場旅費交通費"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("現場福利厚生費", SqlDbType.VarChar));
                        Cmd.Parameters["現場福利厚生費"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("現場通信費", SqlDbType.VarChar));
                        Cmd.Parameters["現場通信費"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("現場雑費", SqlDbType.VarChar));
                        Cmd.Parameters["現場雑費"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("現場車両費", SqlDbType.VarChar));
                        Cmd.Parameters["現場車両費"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("現場リース料", SqlDbType.VarChar));
                        Cmd.Parameters["現場リース料"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("現場減価償却費", SqlDbType.VarChar));
                        Cmd.Parameters["現場減価償却費"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("現場指現場運営", SqlDbType.VarChar));
                        Cmd.Parameters["現場指現場運営"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("現場消耗品費", SqlDbType.VarChar));
                        Cmd.Parameters["現場消耗品費"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("現場水道光熱費", SqlDbType.VarChar));
                        Cmd.Parameters["現場水道光熱費"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("現場地代家賃", SqlDbType.VarChar));
                        Cmd.Parameters["現場地代家賃"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("商品仕入高", SqlDbType.VarChar));
                        Cmd.Parameters["商品仕入高"].Direction = ParameterDirection.Input;

                        //管理経費
                        Cmd.Parameters.Add(new SqlParameter("部門管理経費率", SqlDbType.VarChar));
                        Cmd.Parameters["部門管理経費率"].Direction = ParameterDirection.Input;

                        Cmd.Parameters.Add(new SqlParameter("共通管理経費率", SqlDbType.VarChar));
                        Cmd.Parameters["共通管理経費率"].Direction = ParameterDirection.Input;
                        ...
                        Cmd.Parameters["現場旅費交通費"].Value = ryohi.Value.ToString();
                        Cmd.Parameters["現場福利厚生費"].Value = hukuri.Value.ToString();
                        Cmd.Parameters["現場通信費"].Value = tuushin.Value.ToString();
                        Cmd.Parameters["現場雑費"].Value = zappi.Value.ToString();
                        Cmd.Parameters["現場車両費"].Value = syaryou.Value.ToString();
                        Cmd.Parameters["現場リース料"].Value = riisu.Value.ToString();
                        Cmd.Parameters["現場減価償却費"].Value = syoukyaku.Value.ToString();
                        Cmd.Parameters["現場指現場運営"].Value = unei.Value.ToString();
                        Cmd.Parameters["現場消耗品費"].Value = syoumou.Value.ToString();
                        Cmd.Parameters["現場水道光熱費"].Value = kounetsu.Value.ToString();
                        Cmd.Parameters["現場地代家賃"].Value = yachin.Value.ToString();
                        Cmd.Parameters["商品仕入高"].Value = shiire.Value.ToString();

                        Cmd.Parameters["部門管理経費率"].Value = bumonkanri.Value.ToString();
                        Cmd.Parameters["共通管理経費率"].Value = kyoutsuukanri.Value.ToString();
        ...
        private void dataGridView2_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            dataGridView2.Rows[27].DefaultCellStyle.BackColor = Color.DeepSkyBlue; //一人当たりの人件費
            //dataGridView2.Rows[28].DefaultCellStyle.BackColor = Color.RoyalBlue; //1H換算

            for (int i = 29; i <= 40; i++)
            {
                dataGridView2.Rows[i].DefaultCellStyle.BackColor = Color.LightGreen;　//現場経費
            }

            dataGridView2.Rows[41].DefaultCellStyle.BackColor = Color.ForestGreen; //現場諸経費合計

            dataGridView2.Rows[42].DefaultCellStyle.BackColor = Color.NavajoWhite; //部門管理経費
            dataGridView2.Rows[43].DefaultCellStyle.BackColor = Color.NavajoWhite; //共通管理経費

            dataGridView2.Rows[44].DefaultCellStyle.BackColor = Color.Orange; //原価
