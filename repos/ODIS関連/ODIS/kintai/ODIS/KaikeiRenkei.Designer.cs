...
namespace ODIS.ODIS
{
    partial class KaikeiRenkei
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button1.Text = "売上データコピー(プロステージ⇒SqlServer)";
            ...
            this.button2.Text = "入金データコピー(プロステージ⇒SqlServer)";
            ...
            this.button4.Text = "入金伝票一覧表示(伝票削除用)";
